...
payment_type_select = InlineKeyboardMarkup(
    inline_keyboard=[
        
        InlineKeyboardButton(text='Uzcard', callback_data='uzcard_pay_card'),
        InlineKeyboardButton(text='Xumo', callback_data='xumo_pay_card'),
